...
// ���ڽ�����ر���
volatile u16 uart_rx_timeout_cnt = 0;   // ���ڽ��ճ�ʱ��������10us��λ��
static u16 uart_timeout_threshold = 0;         // 3.5�ַ�ʱ����ֵ��10us��λ��
...
void	UART_config(void)
{
	...
	COMx_InitStructure.UART_BaudRate  = 115200ul;			//������, �ڱ������У���ʱ��16λ�������������õ�2400~115200
...
//	Timer0_Run(1);    // ����
//	Timer0_Stop();    // ֹͣ
//	T0_Load(65536UL - (MAIN_Fosc / 100000UL));  // ��������
